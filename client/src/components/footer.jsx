...
//   return (
//     <footer className="bg-gradient-to-r from-slate-50 to-gray-100 text-gray-700 mt-16 border-t border-gray-200">
//       <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
//         {/* Supported Sites */}
//         <div className="flex flex-col">
//           <h4 className="font-semibold text-lg mb-4 text-gray-800">Supported Sites</h4>
...
//                 src="https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg"
//                 alt="Amazon"
//                 className="h-6 opacity-80 hover:opacity-100"
//               />
//             </a>
...
//             <li className="hover:text-blue-600 cursor-pointer transition-colors">Favorites</li>
    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-16">
        ...
        <div className="flex flex-col">
          ...
          <ul className="space-y-2 text-sm">
            <li>Email: <a href="mailto:support@bluecart.com" className="text-blue-600 hover:underline">support@bluecart.com</a></li>
            <li>Phone: <a href="tel:+1234567890" className="text-blue-600 hover:underline">+254723456933</a></li>
            <li>Address: Nairobi, Kenya</li>
